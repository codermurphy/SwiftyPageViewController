...
extension Page4ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "page4 row: \(indexPath.row)"
        return cell
    }

}

extension Page4ViewController: MPChildViewControllerProtocol {
